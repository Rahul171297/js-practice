...
/**************************************************
  Section 02 👉 Data Types in Javascript
**************************************************/

/**
  JavaScript has 8 Primitive Data Types
  1. String => var myName = "Rahul Kumar";
  2. Number => var myAge = 26;
  3. Boolean => var iamRahul = true/false;
  4. Undefined => var childName;
  5. Null => var iamTired = null;
  6. Bigint =>
  7. Symbol =>
  8. Object =>
**/

// typeof Operators => typeof() (To find the type of any Value)
...
// What is NaN? => In JavaScript, NaN is short for "Not-a-Number". It is a number which is not actually a legal number. The Global NaN property is the same as the Number Nan property. The isNaN() method returns true if a value is NaN.

// Difference between isNaN() and Number.isNaN() => isNaN() method returns true if a value is Not-a-Number. Number.isNaN() returns true if a number is Not-a-Number. In other words: isNaN() converts the value to a number before testing it.
...
/**************************************************
  Section 03 👉 Expressions and Operators in JavaScript
**************************************************/
...
/**
  JavaScript has 6 different Operators types
...
// 1️⃣ Assignment operators => An assignment operator assigns a value to its left operand based on the value of its right operand. The simple assignment operator is equal (=)

// var myName = "Rahul Kumar", myAge = 26;

// console.log("is both the myName and myAge are equal or not" + myName == myAge );

// I will tell you when we will see es6
// console.log(`Is both the myName and myAge are equal : ${myName == myAge}`);


// 2️⃣ Arithmetic operators => An arithmetic operator takes numerical values (either literals or variables) as their operands and returns a single numerical value.

// console.log(3 + 3);
// console.log(10 - 5);
// console.log(20 / 5);
// console.log(5 * 6);
// console.log("Remainder Operator " + 27 % 4); // % is called as a Modular Operator


// 🙄 Increment and Decrement operator => Operator: x++ / ++x / x-- / --x
...
// console.log(a > b && b > 0); // Here output of 2nd expression is "False" so overall output will be "False".
// console.log(a > b && b > -50 && b < 0); // Here output for all the expressions are "True" so overall output will be "True".
